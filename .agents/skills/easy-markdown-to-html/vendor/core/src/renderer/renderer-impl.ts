...
export function initRenderer(opts: IOpts = {}): RendererAPI {
  ...
  // NOTE (easy-markdown-to-html): mermaid / plantuml / infographic diagram
  // extensions are intentionally NOT registered — they need a browser DOM and
  // crash or emit loading placeholders in a headless environment. See
  // extensions/index.ts. Diagram rendering is a v2 enhancement.
